...
import ink.moshuier.silken.service.NationService;
...
public class NationServiceImpl implements NationService {
	...
	public JSONArray getTree() {
		...
		m1.accumulate("id", get("�й�").getId());
		m1.accumulate("text", "�й�");
		m2.accumulate("id", get("����").getId());
		m2.accumulate("text", "����");
		tree.add(m1);
		tree.add(m2);
		////////////////////////zhonghua////////////////////
		...
		for(Nation nation : cs){
			if(!nation.getContinent().equals(continentName)){
				if(children != null){
					branch.accumulate("children", children);//����������ֵ����add
					tree.add(branch);
				}
