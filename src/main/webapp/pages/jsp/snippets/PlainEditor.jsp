...
<%@page import="ink.moshuier.silken.entity.User" %>
		<div class="comment-editor">
				<a href="javascript:;" class="avatar-wrapper" id="commentAvatarHolder" rel="nofollow">
					<img src='<%=request.getAttribute("loginedUser")!=null?pageContext.getAttribute("imageUrl")+((User)request.getAttribute("loginedUser")).getPortrait():"img/common/avatar.gif"%>' class="avatar rounded">
				</a>
