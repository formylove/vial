...
<s:select multiple="true" name="population" list="@ink.moshuier.silken.common.MsgConstants@CU" listKey="key" listValue="value"/>
<br>
...
<br>
<s:updownselect name="nations" list="@ink.moshuier.silken.common.MsgConstants@AUTHORITY" listKey="key" listValue="value"/>
<s:radio name="gender" list="@ink.moshuier.silken.common.MsgConstants@GENDER"></s:radio>
<br>
