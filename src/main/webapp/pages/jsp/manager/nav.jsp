...
<div class="easyui-accordion" id="rightside-nav" style="width:200px;height:400px;">
		...
		<div title="创作" id="createItem" name="createItem" data-options="iconCls:'icon-add'" style="padding:10px;">
			<ul class="easyui-tree">
								...
								<li><a href="manager/opus/emovie">电影</a></li>
								<li><a href="manager/opus/ebook">书籍</a></li>
								<li><a href="manager/opus/eseries">书籍</a></li>
								<li><a href="manager/nation/edit">行政单元</a></li>
								<li><a href="manager/dynasty/edit">朝代民族</a></li>
								<li><a href="manager/corporation/edit">公司</a></li>
								<li><a href="manager/figure/edit">人物</a></li>
<!-- 								<li><a href="manager/scenery/edit">景点</a></li> -->
		...
		<div title="消息发布" data-options="iconCls:'icon-tip'" style="padding:10px;">
