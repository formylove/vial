	...
	<form id="nation-editor" action="manager/nation/save/" method="post">
	    	...
	    	<table cellpadding="5">
	    		...
	    		<tr>
	    			<td>民族:</td>
	    			<td>
	    			<s:select list="@ink.moshuier.silken.service.impl.PeopleServiceImpl@getPeoples()" listKey="key" listValue="value" cssClass="easyui-combobox" id="people" name='nation.people.id' ></s:select>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>宗教:</td>
	    			<td>
	    			<s:select list="@ink.moshuier.silken.service.impl.ReligionServiceImpl@getReligions()" listKey="key" listValue="value" cssClass="easyui-combobox" id="religion" name='nation.religion.id' ></s:select>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>建国:</td>
	    		...
	    		<tr>
	    			<td>大陆:</td>
	    			<td>
	    			<s:select list="@ink.moshuier.silken.entity.gallery.Continent@values()" listKey="name" listValue="name" id="continent" name="nation.continent" cssClass="easyui-combobox"></s:select>
	    			</td>
	    		</tr>
	    		<tr>
                    <td>简介:</td>
