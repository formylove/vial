...
<div class="easyui-panel" title="电影"  style="width: 760px; height: 1085px">
	<div style="padding-top: 10px;padding-left: 10px">
	<form id="movie-editor" action="manager/opus/save/" method="post">
			...
			<input type="hidden" name="opus.type" id="type" value="movie">
			<div class="clearfix">
			<div class="fleft">
	    	<table cellpadding="5">
	    		<tr>
	    		...
	    		<tr>
	    			<td>类型:</td>
	    			<td>
	    			<s:select list="@ink.moshuier.silken.service.impl.GenreServiceImpl@getAll().{?#this.type=='movie'}" listKey="id" listValue="name" id="genre0" name="opus.genres[0].id" cssClass="easyui-combobox"></s:select>
	    			<s:select list="@ink.moshuier.silken.service.impl.GenreServiceImpl@getAll().{?#this.type=='movie'}" listKey="id" listValue="name" id="genre1" name="opus.genres[1].id" cssClass="easyui-combobox"></s:select>
	    			<s:select list="@ink.moshuier.silken.service.impl.GenreServiceImpl@getAll().{?#this.type=='movie'}" listKey="id" listValue="name" id="genre2" name="opus.genres[2].id" cssClass="easyui-combobox"></s:select>
