	...
	<form id="series-editor" action="manager/opus/save/" method="post">
	    	...
	    	<table cellpadding="5">
	    		...
	    		<tr>
	    			<td>类型:</td>
	    			<td>
	    			<s:select list="@ink.moshuier.silken.service.impl.GenreServiceImpl@getAll().{?#this.type=='series'}" listKey="id" listValue="name" id="genre0" name="opus.genres[0].id" cssClass="easyui-combobox"></s:select>
	    			<s:select list="@ink.moshuier.silken.service.impl.GenreServiceImpl@getAll().{?#this.type=='series'}" listKey="id" listValue="name" id="genre1" name="opus.genres[1].id" cssClass="easyui-combobox"></s:select>
	    			<s:select list="@ink.moshuier.silken.service.impl.GenreServiceImpl@getAll().{?#this.type=='series'}" listKey="id" listValue="name" id="genre2" name="opus.genres[2].id" cssClass="easyui-combobox"></s:select>
